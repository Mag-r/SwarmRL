...
class GlobalTrajectoryInformation:
    ...
    actions: list = field(default_factory=lambda: jnp.array([]))
    ...
    occupancy_map: jnp.ndarray = field(default_factory=list)
    next_occupancy_map: jnp.ndarray = field(default_factory=list)
    killed: bool = False
